...
function setup(){
    ...
    blocking1 = new blocks(620,220,40,40);

    blockes1 = new blocks(600,250,40,40);
    blockes2 = new blocks(640,250,40,40);
    blockes3 = new blocks(640,250,40,40);
    blockes4 = new blocks(1165+30,180,40,40);

    blocked1 = new blocks(603.4,299,40,40);
    blocked3 = new blocks(1175,250,40,40);
    blocked4 = new blocks(1210,250,40,40);
    ...
    block2 = new blocks(535,399,40,40);
    block3 = new blocks(570,399,40,40);
    block4 = new blocks(605,399,40,40);
    block5 = new blocks(660,399,40,40);
    block6 = new blocks(680,399,40,40);
    block7 = new blocks(710,399,40,40);
    block8 = new blocks(744,399,40,40);
    ///block9 = new blocks(1105,315,40,40);
    block10 = new blocks(1135+13,304,40,40);
    block11 = new blocks(1170+5,304,40,40);
    block12 = new blocks(1200+5,304,40,40);
    block13 = new blocks(1245-5,304,40,40);
    block14 = new blocks(1295-5,307,40,40);
    ground = new Ground(640,400,400,20);
    platform = new Ground(1190, 305, 450, 20);

    ball = Bodies.circle(380,200,80);
...
function keyPressed(){
    if(keyCode === 32){
        Matter.Body.setPosition(this.ball,{x:380,y:200});
